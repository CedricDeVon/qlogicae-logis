...
def copy(
    ...
    cli_manager.singleton.handle_filesystem_copy(
...
def move(
    ...
    cli_manager.singleton.handle_filesystem_move(
        source_path=source_path,
...
def rename(
    ...
    cli_manager.singleton.handle_filesystem_rename(
        old_path=old_path,
        new_path=new_path,
    )
...
def setup(
    ...
    cli_manager.singleton.handle_filesystem_tree_setup(
        target_paths=target_paths
    )
...
def path(
    ...
    cli_manager.singleton.handle_filesystem_clean_path(
        target_paths=target_paths
    )
...
def selection(
    ...
    cli_manager.singleton.handle_filesystem_clean_selection(
        targets=targets
    )
...
def included() -> bool:
    cli_manager.singleton.handle_filesystem_clean_list_included()
